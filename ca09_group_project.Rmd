...
```{r}
airbnb_1$review_scores_rating[is.na(airbnb_1$review_scores_rating)] <- round(mean(airbnb_1$review_scores_rating, na.rm = TRUE))
...
```{r}
myvars <- c("price","property_type","room_type")
new_data <- listings[myvars]
```
